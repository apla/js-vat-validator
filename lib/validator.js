...
(function(root, factory) {
    ...
    function checkVATNumber(toCheck) {
        ...
        for (i = 0; i < vatexp.length; i++) {
            ...
            if (vatexp[i].test(VATNumber)) {
                ...
                if (VATCheckDigitMap[cCode](cNumber)) valid = VATNumber;
    ...
    function CZVATCheckDigit(vatnumber) {
        ...
        // Individuals type 1
            ...
            if (Number(vatnumber.slice(0, 2)) > 53) return false;
            return true;
        }
        ...
        // Individuals type 3
            ...
            var temp = Number(vatnumber.slice(0, 2)) + Number(vatnumber.slice(2, 4)) + Number(vatnumber.slice(4, 6)) +
                Number(vatnumber.slice(6, 8)) + Number(vatnumber.slice(8));
    ...
    function IEVATCheckDigit(vatnumber) {
        ...
        if (/^\d[A-Z\*\+]/.test(vatnumber)) vatnumber = "0" + vatnumber.substring(2, 7) + vatnumber.substring(0, 1) +
    ...
    var VATCheckDigitMap = {
        AT: ATVATCheckDigit,
        BE: BEVATCheckDigit,
        BG: BGVATCheckDigit,
        CHE: CHEVATCheckDigit,
        CY: CYVATCheckDigit,
        CZ: CZVATCheckDigit,
        DE: DEVATCheckDigit,
        DK: DKVATCheckDigit,
